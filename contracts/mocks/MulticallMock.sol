...
contract MulticallMock {
  ...
  function updateTotalRewardsAndClaim(
    ...
    oracles.submitRewards(
      oracleRewards.totalRewards,
      oracleRewards.activatedValidators,
      oracleRewards.exitedValidators,
      oracleRewards.signatures
    );
  ...
  function claimAndUpdateMerkleRoot(
    ...
    oracles.submitMerkleRoot(
      ...
      merkleRoot.merkleProofs,
      merkleRoot.signatures
    );
  }
