...
contract MerkleDistributor is IMerkleDistributor, OwnablePausableUpgradeable {
  ...
  function initialize(address _admin, address _rewards, address _oracles) external initializer {
  ...
  function setMerkleRoot(
    ...
    string calldata newMerkleProofs
  ) external override {
  ...
  function claim(
    ...
    require(
      MerkleProofUpgradeable.verify(merkleProof, _merkleRoot, node),
  ...
  function _transferToken(address from, address to, address token, uint256 amount) internal {
